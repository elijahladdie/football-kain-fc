...
const Nav = () => {
   ...
   return (
      <>
         ...
         -translate-x-full ${show ? 'translate-x-0 ' : ' '}  z-10  `} aria-label="Sidebar">
               <div className="h-full px-3 py-11 overflow-y-auto bg-gray-50 dark:bg-gray-800">
                  <ul className="space-y-2 font-medium">
                     ...
                     <li>
                        <button type="button" onClick={() => setView((open) => !open)} class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
         ...
         <div class=" bg-gray-50 dark:bg-gray-700 max-screen-xl py-3 " />
      </>
   )
}
