...
const Nav = () => {
   ...
   return (
      <>
         ...
         -translate-x-full ${show ? 'translate-x-0 ' : ' '}  z-10  `} aria-label="Sidebar">
               <div className="h-full px-3 py-11 overflow-y-auto bg-gray-50 dark:bg-gray-800">
                  <ul className="space-y-2 font-medium">
                     <li className="mx-3 flex justify-center">
                        <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white dark:hover:bg-gray-700">
                     ...
                     <li>
                        ...
                        <ul id="dropdown-example" class={` ${view ? 'hidden' : ''} py-2 space-y-2`}>
                           <li>
                              <a href="/admin/app/dashboard/adversaries" class="flex items-center w-full p-2 text-gray-900 transition duration-75 
                              rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Adversaries</a>
                           </li>
                           <li>
                              <a href="/admin/app/dashboard/matches" class="flex items-center w-full p-2 text-gray-900 transition duration-75 
                              rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Matches</a>
                           </li>
                           <li>
                              <a href="/admin/app/dashboard/referees" class="flex items-center w-full p-2 text-gray-900 transition duration-75 
                              rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Referees</a>
                           </li>
                           <li>
                              <a href="/admin/app/dashboard/form" class="flex items-center w-full p-2 text-gray-900 transition duration-75 
                              rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Form</a>
                           </li>
                        </ul>
                     </li>
                     <li>
         ...
         <nav class="flex justify-center bg-white border-gray-200 dark:bg-gray-900">
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl p-4">
               <p class="flex items-center">
                  <img src={img} className="  h-8 mr-3" alt="Kain Logo" />
                  <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">KAIN FC</span>
               </p>
