...
const GetAnnouncement = ({time}) => {
    ...
    return (
        ...
        <h1 className="bg-gradient-to-r from-blue-600 via-green-500 to-indigo-400  inline-block text-transparent bg-clip-text text-center  mb-4 w-full text-4xl font-extrabold leading-none tracking-tight   md:text-5xl lg:text-6xl py-4 ">
         {time} announcements
            ...
            {(announce !== null) ? (announce.map(match => (
    ...
    <a href="#" className="inline-flex items- items-center px-3 py-2 text-sm my-3 font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" >
            Load more 
